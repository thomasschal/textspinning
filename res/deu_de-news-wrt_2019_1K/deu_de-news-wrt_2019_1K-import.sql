...
CREATE DATABASE `deu_de-news-wrt_2019_1K`;

USE `deu_de-news-wrt_2019_1K`;
...
LOAD DATA LOCAL INFILE 'deu_de-news-wrt_2019_1K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'deu_de-news-wrt_2019_1K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'deu_de-news-wrt_2019_1K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'deu_de-news-wrt_2019_1K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'deu_de-news-wrt_2019_1K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'deu_de-news-wrt_2019_1K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'deu_de-news-wrt_2019_1K-sources.txt' INTO TABLE sources;
